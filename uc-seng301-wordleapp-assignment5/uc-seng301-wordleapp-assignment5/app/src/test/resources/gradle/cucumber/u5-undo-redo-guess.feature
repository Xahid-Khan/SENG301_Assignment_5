...
#
  ...
  Scenario: AC5 - I can redo all my guesses in reverse order I made the guesses
    Given I am playing the game with manual guesser
    When I make following guesses "meets", "beats", "pully", "undo", "undo", "undo", "redo", "redo", "redo"
    Then stack will only have "meets", "beats", "pully" after performing few undo and redo